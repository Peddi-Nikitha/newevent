          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="md:w-1/2 relative hidden md:block">
              ...
              <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-10">
                <h2 className="text-3xl font-bold mb-4 text-center drop-shadow-lg">Join Our Community</h2>
                <p className="text-center text-lg drop-shadow-lg">
                  Create an account to start planning your perfect events
                </p>
              </div>
            </div>
            ...
            <div className="md:w-1/2 p-8 md:p-12">
              <h1 className="text-3xl font-bold text-heading-primary mb-8">Create Your Account</h1>
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  <label htmlFor="fullName" className="block text-text-light mb-2">Full Name</label>
                  <input
                    type="text"
                    id="fullName"
                    name="fullName"
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    minLength={8}
                  />
                  <p className="text-sm text-text-light mt-1">Must be at least 8 characters</p>
                </div>
                
                <div className="mb-6">
                  <label htmlFor="confirmPassword" className="block text-text-light mb-2">Confirm Password</label>
                  <input
                    type="password"
                    id="confirmPassword"
                ...
                <div className="mb-6">
                  <div className="flex items-center">
                    <input
                      ...
                      required
                    />
                    <label htmlFor="termsCheck" className="text-sm text-text-light">
                      I agree to the <Link href="/terms" className="text-cta-primary hover:underline">Terms of Service</Link> and <Link href="/privacy" className="text-cta-primary hover:underline">Privacy Policy</Link>
                    </label>
                  </div>
                </div>
                ...
                <div className="text-center mt-8">
                  <p className="text-text-light">
                    ...
                    <Link href="/login" className="text-cta-primary hover:underline font-medium">
                      Log In
                    </Link>
                  </p>
                </div>
